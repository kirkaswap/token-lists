import kirkaswapList from "../kirkaswap.token-list.json";
import kirkaswapExperimentalList from "../kirkaswap-experimental.token-list.json";
...
export const defaultList: TokenList = kirkaswapList;
export const experimental: TokenList = kirkaswapExperimentalList;
